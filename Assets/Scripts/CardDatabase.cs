...
public class CardDatabase : MonoBehaviour
{
    ...
    public static readonly Dictionary<CardID, CardConfig> CardConfigs = new Dictionary<CardID, CardConfig> {
        ...
        {CardID.Fox, new CardConfig(Rarity.Common, "Fox", 1, 3, 1, Passive.Fast)},
        ...
        {CardID.Kirby, new CardConfig(Rarity.Common, "Kirby", 2, 2, 1, Passive.Straight)},
        ...
        {CardID.MewTwo, new CardConfig(Rarity.Uncommon, "MewTwo", 2, 3, 2, Passive.Dodge)},
        {CardID.Pikachu, new CardConfig(Rarity.Uncommon, "Pikachu", 2, 2, 1, Passive.Straight)},
        ...
        {CardID.Cloud, new CardConfig(Rarity.Rare, "Cloud", 2, 3, 1, Passive.Fast)},
